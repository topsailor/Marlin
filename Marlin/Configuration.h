...
#define STRING_CONFIG_H_AUTHOR "(JWS, SKRV1.3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "OC335_SKR13"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 20.023
  #define DEFAULT_bedKd 400.4
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 20, 200 } //  Calculated theoreticl max. for X and Y @mstep=32 ~= 375mm/s 
...
#define INVERT_E0_DIR true // ADO MOTOR, flip otherwise
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MAX_POS - 5), 30 }
